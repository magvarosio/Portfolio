        ...
        <Row>
          ...
          <div className='pback'>
            <p className='lead'>I have been in love with tech since I was a child. I used DOS on my first PC, and the first book I read about computer science was HTML for dummies during my summer holidays.
              ...
              I also tried to build my own synthesiser. <br></br> <br></br>Following my passion about tech I worked for Apple as a Trainer for 8 yrs and dreamt about building software from scratch.
